...
namespace Application.UnitTests.UseCases
{
    public class BuyOrderTest
    {
        ...
        private List<NegotiatedAsset> mockMostNegotiatedAssetsFroLastSevenDays;
        ...
        private void ExecuteUseCase(PurchaseOrder purchaseOrder, NegotiatedAsset selectedAsset, int quantity)
        {
            assetToSave = null;
